...
namespace SapConcurApiClient.ExpenseReportModels
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReportPut : IEquatable<ReportPut>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportPut" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ReportPut);
        }

        /// <summary>
        /// Returns true if ReportPut instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportPut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportPut input)
        {
            if (input == null)
                return false;
