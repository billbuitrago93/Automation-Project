...
namespace SapConcurApiClient.PaymentRequestModels
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentRequestLineItemPost : IEquatable<PaymentRequestLineItemPost>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRequestLineItemPost" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentRequestLineItemPost {\n");
        ...
        {
            return this.Equals(input as PaymentRequestLineItemPost);
        }

        /// <summary>
        /// Returns true if PaymentRequestLineItemPost instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRequestLineItemPost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRequestLineItemPost input)
        {
            if (input == null)
                return false;
