...
namespace SapConcurApiClient.PaymentRequestModels
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentRequestPut : IEquatable<PaymentRequestPut>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRequestPut" /> class.
        /// </summary>
        ...
        /// <param name="doCopyDown">Use new Request Owner&#39;s employee copydown values in this request.</param>
        /// <param name="doCopyDownFromPO">Use purchase order copydown values in this request.</param>
        /// <param name="employeeEmailAddress">The email address of the employee to whom the request should be assigned. Not evaluated if EmployeeLoginId or EmployeeId match an employee..</param>
        /// <param name="employeeId">The company ID of the employee to whom the request should be assigned. Has precedence over EmployeeEmail; not evaluated if EmployeeLoginId matches an employee..</param>
        /// <param name="employeeLoginId">The login ID of the employee to whom the request should be assigned. Has precedence over EmployeeId and EmployeeEmail..</param>
        ...
        /// <param name="purchaseOrderId">The ID of the Purchase Order to which the Payment Request should be matched..</param>
        ...
        /// <param name="requestID">The Request ID of the Payment Request.</param>
        ...
        public PaymentRequestPut(string amountWithoutVat = default(string), string buyerCostCenter = default(string), string checkNumber = default(string), string companyBillToAddressCode = default(string), string companyShipToAddressCode = default(string), string countryCode = default(string), string currencyCode = default(string), string custom01 = default(string), string custom02 = default(string), string custom03 = default(string), string custom04 = default(string), string custom05 = default(string), string custom06 = default(string), string custom07 = default(string), string custom08 = default(string), string custom09 = default(string), string custom10 = default(string), string custom11 = default(string), string custom12 = default(string), string custom13 = default(string), string custom14 = default(string), string custom15 = default(string), string custom16 = default(string), string custom17 = default(string), string custom18 = default(string), string custom19 = default(string), string custom20 = default(string), string custom21 = default(string), string custom22 = default(string), string custom23 = default(string), string custom24 = default(string), string deliverySlipNumber = default(string), string description = default(string), string discountPercentage = default(string), string discountTerms = default(string), string doCopyDown = default(string), string doCopyDownFromPO = default(string), string employeeEmailAddress = default(string), string employeeId = default(string), string employeeLoginId = default(string), string invoiceAmount = default(string), string invoiceDate = default(string), string invoiceNumber = default(string), string invoiceReceivedDate = default(string), string isEmergencyCheckRun = default(string), string isInvoiceConfirmed = default(string), PaymentRequestLineItemPut lineItems = default(PaymentRequestLineItemPut), string name = default(string), string notesToVendor = default(string), string oB10BuyerId = default(string), string oB10TransactionId = default(string), string orgUnit01 = default(string), string orgUnit02 = default(string), string orgUnit03 = default(string), string orgUnit04 = default(string), string orgUnit05 = default(string), string orgUnit06 = default(string), string paymentAdjustmentNotes = default(string), string paymentAmount = default(string), string paymentDueDate = default(string), string paymentTermsDays = default(string), string provincialTaxId = default(string), string purchaseOrderId = default(string), string receiptConfirmationType = default(string), string requestID = default(string), string shippingAmount = default(string), string taxAmount = default(string), string vatAmountFour = default(string), string vatAmountOne = default(string), string vatAmountThree = default(string), string vatAmountTwo = default(string), string vatRateFour = default(string), string vatRateOne = default(string), string vatRateThree = default(string), string vatRateTwo = default(string), VendorIdentifier vendorRemitToIdentifier = default(VendorIdentifier), string vendorShipFromAddressCode = default(string), string vendorTaxId = default(string))
        {
            ...
            this.DoCopyDown = doCopyDown;
            this.DoCopyDownFromPO = doCopyDownFromPO;
        ...
        /// <summary>
        /// Use new Request Owner&#39;s employee copydown values in this request
        /// </summary>
        /// <value>Use new Request Owner&#39;s employee copydown values in this request</value>
        [DataMember(Name = "DoCopyDown", EmitDefaultValue = false)]
        public string DoCopyDown { get; set; }

        /// <summary>
        /// Use purchase order copydown values in this request
        /// </summary>
        /// <value>Use purchase order copydown values in this request</value>
        [DataMember(Name = "DoCopyDownFromPO", EmitDefaultValue = false)]
        public string DoCopyDownFromPO { get; set; }

        /// <summary>
        /// The email address of the employee to whom the request should be assigned. Not evaluated if EmployeeLoginId or EmployeeId match an employee.
        /// </summary>
        /// <value>The email address of the employee to whom the request should be assigned. Not evaluated if EmployeeLoginId or EmployeeId match an employee.</value>
        [DataMember(Name = "EmployeeEmailAddress", EmitDefaultValue = false)]
        public string EmployeeEmailAddress { get; set; }

        /// <summary>
        /// The company ID of the employee to whom the request should be assigned. Has precedence over EmployeeEmail; not evaluated if EmployeeLoginId matches an employee.
        /// </summary>
        /// <value>The company ID of the employee to whom the request should be assigned. Has precedence over EmployeeEmail; not evaluated if EmployeeLoginId matches an employee.</value>
        [DataMember(Name = "EmployeeId", EmitDefaultValue = false)]
        public string EmployeeId { get; set; }

        /// <summary>
        /// The login ID of the employee to whom the request should be assigned. Has precedence over EmployeeId and EmployeeEmail.
        /// </summary>
        /// <value>The login ID of the employee to whom the request should be assigned. Has precedence over EmployeeId and EmployeeEmail.</value>
        ...
        public PaymentRequestLineItemPut LineItems { get; set; }
        ...
        /// <summary>
        /// The ID of the Purchase Order to which the Payment Request should be matched.
        /// </summary>
        /// <value>The ID of the Purchase Order to which the Payment Request should be matched.</value>
        ...
        /// <summary>
        /// The Request ID of the Payment Request
        /// </summary>
        /// <value>The Request ID of the Payment Request</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentRequestPut {\n");
            ...
            sb.Append("  DoCopyDown: ").Append(DoCopyDown).Append("\n");
            sb.Append("  DoCopyDownFromPO: ").Append(DoCopyDownFromPO).Append("\n");
        ...
        {
            return this.Equals(input as PaymentRequestPut);
        }

        /// <summary>
        /// Returns true if PaymentRequestPut instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRequestPut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRequestPut input)
        {
            if (input == null)
                return false;
            ...
            return
                ...
                (
                    this.DoCopyDown == input.DoCopyDown ||
                    (this.DoCopyDown != null &&
                    this.DoCopyDown.Equals(input.DoCopyDown))
                ) &&
                (
                    this.DoCopyDownFromPO == input.DoCopyDownFromPO ||
                    (this.DoCopyDownFromPO != null &&
                    this.DoCopyDownFromPO.Equals(input.DoCopyDownFromPO))
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DoCopyDown != null)
                    hashCode = hashCode * 59 + this.DoCopyDown.GetHashCode();
                if (this.DoCopyDownFromPO != null)
                    hashCode = hashCode * 59 + this.DoCopyDownFromPO.GetHashCode();
