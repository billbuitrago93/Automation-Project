...
namespace SapConcurApiClient.PaymentRequestModels
{
    ...
    public partial class LineItem : IEquatable<LineItem>, IValidatableObject
    {
        ...
        public AllocationsCollection Allocations { get; set; }
